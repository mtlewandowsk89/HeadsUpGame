...
'taco', 'fajitas', 'quesadilla', 'nachos', 'hamburger', 'french fries', 'hot dog', 'spaghetti', 'onion rings', 'lasagna', 'pizza', 'ravioli', 'grapes', 'apple', 'pear', 'orange', 'watermelon', 'kiwi', 'cheese', 'pineapple', 'broccoli', 'bread', 'cauliflower', 'spinach', 'potato', 'pudding', 'yogurt', 'jell-o', 'cereal', 'milk', 'soda', 'water', 'beer', 'wine', 'tequila', 'vodka', 'rum', 'whiskey', 'gin', 'limoncello', 'brandy', 'scotch', 'mead', 'eggs', 'tofu', 'pepperoni', 'steak', 'chicken', 'pork', 'tuna', 'salmon', 'shrimp', 'catfish', 'smoothie', 'salad', 'tomato', 'lettuce', 'ketchup', 'bbq sauce', 'peanut butter', 'jelly', 'ranch', '1000 island', 'teriyaki', 'mustard', 'mushroom', 'bell pepper', 'onion', 'tortillas', 'banana', 'honeydew melon', 'dragonfruit', 'ramen', 'fried rice', 'pad thai', 'sub sandwich', 'gyro', 'olive', 'ice cream', 'lollipop', 'hot fudge', 'sprinkles', 'caramel', 'chocolate', 'cinnamon', 'pie', 'cookies', 'lemon', 'lime', 'grapefruit',
'cat', 'dog', 'horse', 'llama', 'chicken', 'goat', 'rooster', 'turkey', 'mouse', 'rat', 'gerbil', 'hamster', 'guinea pig', 'chinchilla', 'lamb', 'cow', 'zebra', 'ox', 'giraffe', 'gecko', 'snake', 'chameleon', 'toad', 'frog', 'bat', 'pigeon', 'eagle', 'hawk', 'wasp', 'bee', 'beetle', 'ant', 'ladybug', 'caterpillar', 'worm', 'butterfly', 'mosquito', 'flea', 'praying mantis', 'stick bug', 'slug', 'snail', 'albatross', 'seagull', 'dove', 'crane', 'flamingo', 'pelican', 'stork', 'ostrich', 'emu', 'turtle', 'jellyfish', 'tortoise', 'plankton', 'dolphin', 'whale', 'shark', 'seal', 'squid', 'octopus', 'crab', 'lobster', 'tiger', 'wolf', 'bear', 'lion', 'camel', 'leopard', 'cheetah', 'jaguar', 'elephant', 'skunk', 'anteater', 'hippopotamus', 'alligator', 'crocodile', 'walrus', 'stingray', 'starfish', 'seahorse', 'weasel', 'orangutan', 'gorilla', 'baboon', 'fox', 'hummingbird', 'woodpecker', 'coyote', 'javelina', 'scorpion', 'tarantula', 'rhino', 'cockroach', 'cricket', 'bull',
